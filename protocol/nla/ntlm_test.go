...
func TestNTLMv2_ComputeResponse(t *testing.T) {
	...
	// Expected values follow MS-NLMP 3.3.2 where temp ends with the AvPairs
	// (which already terminate with MsvAvEOL) followed by Z(4). This matches
	// Azure/go-ntlmssp's computeNtlmV2Response.
